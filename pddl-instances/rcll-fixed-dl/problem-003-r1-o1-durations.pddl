(define (problem rcll-production-003-durative)
	...
	(:init 
		...
		(= (path-length C-BS INPUT C-CS2 OUTPUT) 1.93048)
		(= (path-length C-BS INPUT C-DS INPUT) 6.80637)
		(= (path-length C-BS INPUT C-DS OUTPUT) 6.34512)
		...
		(= (path-length C-CS1 INPUT C-DS INPUT) 6.13292)
		...
		(= (path-length C-CS2 INPUT C-CS2 OUTPUT) 3.05151)
		(= (path-length C-CS2 INPUT C-DS INPUT) 6.290777)
		(= (path-length C-CS2 INPUT C-DS OUTPUT) 5.829528)
		(= (path-length C-CS2 OUTPUT C-BS INPUT) 1.93048)
		...
		(= (path-length START INPUT C-CS1 INPUT) 10.52446)
		(= (path-length START INPUT C-CS1 OUTPUT) 7.22184)

(define (problem rcll-production-004-durative)
	...
	(:init 
		...
		(= (path-length C-BS OUTPUT C-CS2 OUTPUT) 3.48307)
		...
		(= (path-length C-CS1 OUTPUT C-CS2 OUTPUT) 10.28123)
		...
		(= (path-length C-CS2 OUTPUT C-BS OUTPUT) 3.48307)
		...
		(= (path-length C-CS2 OUTPUT C-DS OUTPUT) 6.82309)
		...
		(= (path-length C-DS INPUT C-CS1 OUTPUT) 8.20952)
		...
		(= (path-length C-DS OUTPUT C-CS2 OUTPUT) 6.82309)
		...
		(= (path-length START INPUT C-DS OUTPUT) 6.66397)
	)

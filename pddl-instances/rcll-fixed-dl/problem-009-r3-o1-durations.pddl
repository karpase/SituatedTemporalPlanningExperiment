(define (problem rcll-production-009-durative)
	...
	(:init 
		...
		(= (path-length C-BS INPUT C-CS1 OUTPUT) 9.81468)
		...
		(= (path-length C-BS OUTPUT C-CS1 OUTPUT) 8.01405)
		...
		(= (path-length C-CS1 OUTPUT C-BS INPUT) 9.81468)
		(= (path-length C-CS1 OUTPUT C-BS OUTPUT) 8.01405)
		...
		(= (path-length C-CS2 OUTPUT C-DS INPUT) 6.90343)
		...
		(= (path-length C-DS INPUT C-CS2 OUTPUT) 6.90343)
		...
		(= (path-length C-DS OUTPUT C-CS2 OUTPUT) 5.48877)

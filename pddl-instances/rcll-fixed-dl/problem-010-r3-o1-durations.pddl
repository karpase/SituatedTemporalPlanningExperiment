(define (problem rcll-production-010-durative)
	...
	(:init 
		...
		(= (path-length C-BS INPUT C-DS OUTPUT) 7.99465)
		...
		(= (path-length C-BS OUTPUT C-DS OUTPUT) 8.24593)
		...
		(= (path-length C-CS1 INPUT C-CS2 INPUT) 5.88059)
		...
		(= (path-length C-CS1 OUTPUT C-DS INPUT) 3.57186)
		...
		(= (path-length C-CS2 INPUT C-CS1 INPUT) 5.88059)
		(= (path-length C-CS2 INPUT C-CS1 OUTPUT) 8.078625)
		(= (path-length C-CS2 INPUT C-CS2 OUTPUT) 2.58472)
		...
		(= (path-length C-CS2 OUTPUT C-CS2 INPUT) 2.58472)
		...
		(= (path-length C-DS OUTPUT C-BS OUTPUT) 8.24593)
		...
		(= (path-length START INPUT C-CS2 OUTPUT) 6.49454)

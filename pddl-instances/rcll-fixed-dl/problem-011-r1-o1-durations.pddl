(define (problem rcll-production-011-durative)
	...
	(:init 
		...
		(= (path-length C-BS INPUT C-BS OUTPUT) 3.59399)
		...
		(= (path-length C-BS INPUT C-DS INPUT) 8.44057)
		(= (path-length C-BS INPUT C-DS OUTPUT) 7.319964)
		(= (path-length C-BS OUTPUT C-BS INPUT) 3.59399)
		...
		(= (path-length C-DS INPUT C-BS INPUT) 8.44057)
		...
		(= (path-length START INPUT C-CS1 INPUT) 8.35267)

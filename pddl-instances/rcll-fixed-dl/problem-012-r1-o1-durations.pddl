(define (problem rcll-production-012-durative)
	...
	(:init 
		...
		(= (path-length C-BS INPUT C-CS1 OUTPUT) 7.41677)
		...
		(= (path-length C-CS2 OUTPUT C-DS OUTPUT) 2.13643)
		(= (path-length C-DS INPUT C-BS INPUT) 7.838376)
		(= (path-length C-DS INPUT C-BS OUTPUT) 8.261719)
		(= (path-length C-DS INPUT C-CS1 INPUT) 6.73807)
		...
		(= (path-length START INPUT C-CS1 INPUT) 7.67032)

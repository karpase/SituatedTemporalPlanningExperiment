(define (problem rcll-production-016-durative)
	...
	(:init 
		...
		(= (path-length C-BS INPUT C-DS INPUT) 8.3828)
		...
		(= (path-length C-CS2 OUTPUT C-CS1 OUTPUT) 9.96774)
		...
		(= (path-length START INPUT C-CS2 INPUT) 4.34328)
		(= (path-length START INPUT C-CS2 OUTPUT) 4.050368)
		(= (path-length START INPUT C-DS INPUT) 7.28351)

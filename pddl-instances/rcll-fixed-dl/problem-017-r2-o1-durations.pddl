(define (problem rcll-production-017-durative)
	...
	(:init 
		...
		(= (path-length C-CS1 INPUT C-CS1 OUTPUT) 3.92916)
		...
		(= (path-length C-CS1 OUTPUT C-CS1 INPUT) 3.92916)
		...
		(= (path-length C-CS2 OUTPUT C-DS INPUT) 6.17657)
		...
		(= (path-length C-DS INPUT C-CS2 OUTPUT) 6.17657)

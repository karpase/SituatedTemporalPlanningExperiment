(define (problem rcll-production-019-durative)
	...
	(:init 
		...
		(= (path-length C-BS INPUT C-CS1 OUTPUT) 6.45688)
		...
		(= (path-length C-CS1 OUTPUT C-CS2 OUTPUT) 5.54511)
		...
		(= (path-length C-CS2 OUTPUT C-CS1 OUTPUT) 5.54511)
		...
		(= (path-length START INPUT C-DS OUTPUT) 5.86665)
	)

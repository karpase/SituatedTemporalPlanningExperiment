(define (problem rcll-production-020-durative)
	...
	(:init 
		...
		(= (path-length C-BS INPUT C-CS2 OUTPUT) 8.09825)
		(= (path-length C-BS INPUT C-DS INPUT) 6.710319)
		(= (path-length C-BS INPUT C-DS OUTPUT) 6.80508)
		...
		(= (path-length C-CS1 OUTPUT C-CS2 OUTPUT) 2.89483)
		...
		(= (path-length C-CS2 OUTPUT C-BS INPUT) 8.09825)
		...
		(= (path-length C-CS2 OUTPUT C-DS OUTPUT) 3.03731)
		(= (path-length C-DS INPUT C-BS INPUT) 6.71032)
		...
		(= (path-length C-DS OUTPUT C-BS INPUT) 6.80508)
		...
		(= (path-length C-DS OUTPUT C-CS2 OUTPUT) 3.03731)
		...
		(= (path-length START INPUT C-DS OUTPUT) 5.98846)
	)

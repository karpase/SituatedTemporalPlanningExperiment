(define (problem rcll-production-021-durative)
	...
	(:init 
		...
		(= (path-length C-CS2 INPUT C-CS1 INPUT) 12.20438)
		...
		(= (path-length C-DS INPUT C-CS1 INPUT) 6.61967)
		...
		(= (path-length START INPUT C-CS1 OUTPUT) 5.85255)

(define (problem rcll-production-023-durative)
	...
	(:init 
		...
		(= (path-length C-BS OUTPUT C-CS1 INPUT) 9.20362)
		...
		(= (path-length C-CS1 INPUT C-BS INPUT) 8.64571)
		...
		(= (path-length C-CS1 INPUT C-CS2 OUTPUT) 7.57718)
		...
		(= (path-length C-DS OUTPUT C-CS1 INPUT) 6.2445)

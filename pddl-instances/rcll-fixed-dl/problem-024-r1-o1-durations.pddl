(define (problem rcll-production-024-durative)
	...
	(:init 
		...
		(= (path-length C-BS INPUT C-CS1 INPUT) 8.693)
		...
		(= (path-length C-CS1 INPUT C-BS INPUT) 8.693)
		...
		(= (path-length C-CS2 OUTPUT C-DS OUTPUT) 7.40099)
		...
		(= (path-length C-DS OUTPUT C-CS2 INPUT) 8.37015)
		(= (path-length C-DS OUTPUT C-CS2 OUTPUT) 7.40099)

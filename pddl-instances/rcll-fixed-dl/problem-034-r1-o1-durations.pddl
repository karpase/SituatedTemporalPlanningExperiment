(define (problem rcll-production-034-durative)
	...
	(:init 
		...
		(= (path-length C-BS INPUT C-CS2 OUTPUT) 10.3675)
		...
		(= (path-length C-BS OUTPUT C-CS2 INPUT) 10.72304)
		...
		(= (path-length C-CS1 INPUT C-CS1 OUTPUT) 4.51486)
		...
		(= (path-length C-CS1 OUTPUT C-CS1 INPUT) 4.51486)
		...
		(= (path-length C-CS2 INPUT C-CS1 OUTPUT) 10.52715)
		(= (path-length C-CS2 INPUT C-CS2 OUTPUT) 4.71689)
		...
		(= (path-length C-DS INPUT C-CS1 INPUT) 6.82025)

(define (problem rcll-production-036-durative)
	...
	(:init 
		...
		(= (path-length C-BS INPUT C-DS OUTPUT) 6.84059)
		...
		(= (path-length C-BS OUTPUT C-DS INPUT) 7.61939)
		...
		(= (path-length C-CS1 INPUT C-CS2 OUTPUT) 4.51754)
		...
		(= (path-length C-CS2 OUTPUT C-CS1 INPUT) 4.51754)
		(= (path-length C-CS2 OUTPUT C-CS1 OUTPUT) 6.916464)
		(= (path-length C-CS2 OUTPUT C-CS2 INPUT) 3.08575)
		...
		(= (path-length C-DS INPUT C-BS OUTPUT) 7.61939)
		...
		(= (path-length C-DS OUTPUT C-BS INPUT) 6.84059)
		...
		(= (path-length START INPUT C-DS OUTPUT) 6.54872)
	)

(define (problem rcll-production-037-durative)
	...
	(:init 
		...
		(= (path-length C-BS INPUT C-DS INPUT) 7.2087)
		...
		(= (path-length C-CS1 OUTPUT C-CS1 INPUT) 3.14966)
		...
		(= (path-length C-CS2 INPUT C-CS2 OUTPUT) 4.28791)
		...
		(= (path-length C-CS2 OUTPUT C-CS2 INPUT) 4.28791)
		...
		(= (path-length C-DS INPUT C-CS1 INPUT) 6.27041)

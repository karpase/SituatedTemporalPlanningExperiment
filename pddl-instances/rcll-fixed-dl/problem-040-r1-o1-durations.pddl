(define (problem rcll-production-040-durative)
	...
	(:init 
		...
		(= (path-length C-CS1 INPUT C-DS INPUT) 7.30367)
		...
		(= (path-length C-DS INPUT C-CS1 INPUT) 7.30367)
		...
		(= (path-length C-DS INPUT C-DS OUTPUT) 3.52692)
		...
		(= (path-length C-DS OUTPUT C-DS INPUT) 3.52692)
		...
		(= (path-length START INPUT C-CS1 OUTPUT) 2.25053)

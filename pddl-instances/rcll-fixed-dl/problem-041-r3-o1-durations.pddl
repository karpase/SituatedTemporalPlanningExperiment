(define (problem rcll-production-041-durative)
	...
	(:init 
		...
		(= (path-length C-BS INPUT C-CS1 INPUT) 7.19137)
		...
		(= (path-length C-BS OUTPUT C-CS1 OUTPUT) 4.13858)
		...
		(= (path-length C-CS1 INPUT C-BS INPUT) 7.19137)
		...
		(= (path-length C-CS1 OUTPUT C-BS OUTPUT) 4.13858)
		(= (path-length C-CS1 OUTPUT C-CS1 INPUT) 4.099987)
		(= (path-length C-CS1 OUTPUT C-CS2 INPUT) 8.32361)
		...
		(= (path-length C-CS2 OUTPUT C-DS OUTPUT) 8.34177)
		...
		(= (path-length C-DS OUTPUT C-CS1 OUTPUT) 5.24446)
		(= (path-length C-DS OUTPUT C-CS2 INPUT) 6.150746)
		(= (path-length C-DS OUTPUT C-CS2 OUTPUT) 8.34177)
		(= (path-length C-DS OUTPUT C-DS INPUT) 4.331247)
		(= (path-length START INPUT C-BS INPUT) 2.150619)
		(= (path-length START INPUT C-BS OUTPUT) 3.73706)
		...
		(= (path-length START INPUT C-DS INPUT) 6.28791)
		(= (path-length START INPUT C-DS OUTPUT) 4.84294)
	)

(define (problem rcll-production-046-durative)
	...
	(:init 
		...
		(= (path-length C-BS OUTPUT C-CS1 INPUT) 2.33384)
		...
		(= (path-length C-CS1 INPUT C-BS OUTPUT) 2.33384)

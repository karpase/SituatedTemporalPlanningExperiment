(define (problem rcll-production-047-durative)
	...
	(:init 
		...
		(= (path-length C-BS OUTPUT C-CS1 OUTPUT) 10.59117)
		...
		(= (path-length C-CS1 INPUT C-BS INPUT) 10.9251)
		...
		(= (path-length C-DS INPUT C-BS INPUT) 9.33459)
		...
		(= (path-length C-DS OUTPUT C-BS INPUT) 8.30599)
		...
		(= (path-length START INPUT C-BS OUTPUT) 2.17435)
		...
		(= (path-length START INPUT C-DS OUTPUT) 7.33491)
	)

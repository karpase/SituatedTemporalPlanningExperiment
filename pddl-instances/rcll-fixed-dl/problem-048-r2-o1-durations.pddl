(define (problem rcll-production-048-durative)
	...
	(:init 
		...
		(= (path-length C-CS1 INPUT C-CS2 OUTPUT) 5.75085)
		(= (path-length C-CS1 INPUT C-DS INPUT) 4.886717)
		(= (path-length C-CS1 INPUT C-DS OUTPUT) 4.267403)
		(= (path-length C-CS1 OUTPUT C-BS INPUT) 5.96858)
		...
		(= (path-length C-CS2 INPUT C-BS INPUT) 11.44546)
		...
		(= (path-length C-CS2 OUTPUT C-CS1 INPUT) 5.75085)
		...
		(= (path-length C-DS INPUT C-CS2 OUTPUT) 5.98738)

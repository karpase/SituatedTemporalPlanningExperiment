(define (problem rcll-production-051-durative)
	...
	(:init 
		...
		(= (path-length C-BS INPUT C-DS OUTPUT) 6.33789)
		...
		(= (path-length C-CS2 INPUT C-CS2 OUTPUT) 3.50974)
		(= (path-length C-CS2 INPUT C-DS INPUT) 2.809691)
		(= (path-length C-CS2 INPUT C-DS OUTPUT) 0.545)
		...
		(= (path-length C-CS2 OUTPUT C-CS2 INPUT) 3.50974)
		(= (path-length C-CS2 OUTPUT C-DS INPUT) 4.993625)
		(= (path-length C-CS2 OUTPUT C-DS OUTPUT) 3.9372)
		(= (path-length C-DS INPUT C-BS INPUT) 6.5551)
		...
		(= (path-length C-DS OUTPUT C-BS INPUT) 6.33789)
		...
		(= (path-length C-DS OUTPUT C-CS2 INPUT) 0.545)
		(= (path-length C-DS OUTPUT C-CS2 OUTPUT) 3.9372)
		...
		(= (path-length START INPUT C-CS1 OUTPUT) 5.13896)
		(= (path-length START INPUT C-CS2 INPUT) 5.99452)

(define (problem rcll-production-052-durative)
	...
	(:init 
		...
		(= (path-length C-BS INPUT C-CS1 INPUT) 6.45279)
		(= (path-length C-BS INPUT C-CS1 OUTPUT) 7.388668)
		(= (path-length C-BS INPUT C-CS2 INPUT) 13.667389)
		(= (path-length C-BS INPUT C-CS2 OUTPUT) 10.48267)
		(= (path-length C-BS INPUT C-DS INPUT) 7.66804)
		...
		(= (path-length C-CS1 INPUT C-CS2 INPUT) 7.77992)
		...
		(= (path-length C-CS1 OUTPUT C-CS2 INPUT) 8.14594)
		...
		(= (path-length C-CS2 INPUT C-CS1 OUTPUT) 8.14594)

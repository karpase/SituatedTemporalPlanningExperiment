(define (problem rcll-production-054-durative)
	...
	(:init 
		...
		(= (path-length C-BS INPUT C-CS2 INPUT) 1.44571)
		...
		(= (path-length C-CS1 OUTPUT C-CS2 INPUT) 9.19795)
		...
		(= (path-length C-CS2 INPUT C-BS INPUT) 1.44571)
		...
		(= (path-length C-CS2 OUTPUT C-CS1 INPUT) 8.16412)

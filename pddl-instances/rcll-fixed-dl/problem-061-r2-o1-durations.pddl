(define (problem rcll-production-061-durative)
	...
	(:init 
		...
		(= (path-length C-CS1 OUTPUT C-BS OUTPUT) 3.343)
		...
		(= (path-length C-CS2 INPUT C-BS INPUT) 13.68931)
		...
		(= (path-length C-DS OUTPUT C-CS1 OUTPUT) 5.73255)

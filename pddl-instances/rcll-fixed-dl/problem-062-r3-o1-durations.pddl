(define (problem rcll-production-062-durative)
	...
	(:init 
		...
		(= (path-length C-BS INPUT C-CS2 INPUT) 4.87361)
		...
		(= (path-length C-CS1 INPUT C-CS2 INPUT) 7.85105)
		...
		(= (path-length C-CS2 INPUT C-BS INPUT) 4.87361)
		...
		(= (path-length C-CS2 INPUT C-DS OUTPUT) 5.0042)
		...
		(= (path-length C-DS OUTPUT C-CS1 INPUT) 6.33581)
		(= (path-length C-DS OUTPUT C-CS1 OUTPUT) 7.167922)
		(= (path-length C-DS OUTPUT C-CS2 INPUT) 5.0042)
		...
		(= (path-length START INPUT C-DS INPUT) 6.16117)

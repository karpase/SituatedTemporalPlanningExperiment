(define (problem rcll-production-065-durative)
	...
	(:init 
		...
		(= (path-length C-BS INPUT C-CS1 OUTPUT) 3.18509)
		...
		(= (path-length C-BS OUTPUT C-DS OUTPUT) 6.11473)
		...
		(= (path-length C-CS1 OUTPUT C-BS INPUT) 3.18509)
		...
		(= (path-length C-CS2 INPUT C-CS2 OUTPUT) 2.71577)
		...
		(= (path-length C-CS2 OUTPUT C-CS2 INPUT) 2.71577)
		...
		(= (path-length C-DS OUTPUT C-BS OUTPUT) 6.11473)

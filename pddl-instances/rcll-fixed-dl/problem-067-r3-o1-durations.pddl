(define (problem rcll-production-067-durative)
	...
	(:init 
		...
		(= (path-length C-BS INPUT C-CS1 INPUT) 1.33449)
		(= (path-length C-BS INPUT C-CS1 OUTPUT) 1.40498)
		...
		(= (path-length C-BS OUTPUT C-DS INPUT) 6.86643)
		(= (path-length C-BS OUTPUT C-DS OUTPUT) 7.945524)
		(= (path-length C-CS1 INPUT C-BS INPUT) 1.33449)
		...
		(= (path-length C-CS1 OUTPUT C-CS2 OUTPUT) 9.32947)
		...
		(= (path-length START INPUT C-BS OUTPUT) 1.39736)
		(= (path-length START INPUT C-CS1 INPUT) 1.345729)
		(= (path-length START INPUT C-CS1 OUTPUT) 3.78535)

(define (problem rcll-production-068-durative)
	...
	(:init 
		...
		(= (path-length C-BS INPUT C-CS1 OUTPUT) 5.9652)
		...
		(= (path-length C-BS OUTPUT C-CS2 OUTPUT) 3.54538)
		...
		(= (path-length C-CS2 INPUT C-BS OUTPUT) 4.37366)
		...
		(= (path-length C-DS INPUT C-DS OUTPUT) 3.14753)

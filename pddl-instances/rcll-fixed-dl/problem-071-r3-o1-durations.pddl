(define (problem rcll-production-071-durative)
	...
	(:init 
		...
		(= (path-length C-BS INPUT C-BS OUTPUT) 2.61087)
		(= (path-length C-BS INPUT C-CS1 INPUT) 4.10249)
		...
		(= (path-length C-BS OUTPUT C-BS INPUT) 2.61087)
		...
		(= (path-length C-CS1 INPUT C-BS INPUT) 4.10249)
		(= (path-length C-CS1 INPUT C-BS OUTPUT) 3.344113)
		(= (path-length C-CS1 INPUT C-CS1 OUTPUT) 4.2006)
		...
		(= (path-length C-CS1 OUTPUT C-DS INPUT) 4.14737)
		...
		(= (path-length C-DS INPUT C-CS1 OUTPUT) 4.14737)
		...
		(= (path-length START INPUT C-CS2 INPUT) 6.57191)

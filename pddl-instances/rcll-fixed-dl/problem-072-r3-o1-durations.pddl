(define (problem rcll-production-072-durative)
	...
	(:init 
		...
		(= (path-length C-CS1 OUTPUT C-CS2 INPUT) 7.24247)
		...
		(= (path-length C-CS2 INPUT C-CS1 OUTPUT) 7.24247)
		...
		(= (path-length C-CS2 OUTPUT C-CS1 OUTPUT) 6.88026)
		(= (path-length C-CS2 OUTPUT C-CS2 INPUT) 2.531412)
		(= (path-length C-CS2 OUTPUT C-DS INPUT) 6.973989)
		(= (path-length C-CS2 OUTPUT C-DS OUTPUT) 7.99615)
		...
		(= (path-length C-DS OUTPUT C-CS2 OUTPUT) 7.99615)

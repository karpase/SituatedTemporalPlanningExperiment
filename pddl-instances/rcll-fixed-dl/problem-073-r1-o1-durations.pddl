(define (problem rcll-production-073-durative)
	...
	(:init 
		...
		(= (path-length C-CS2 OUTPUT C-DS OUTPUT) 6.24015)
		(= (path-length C-DS INPUT C-BS INPUT) 7.68493)
		...
		(= (path-length C-DS OUTPUT C-CS2 OUTPUT) 6.24015)
		...
		(= (path-length START INPUT C-CS2 INPUT) 3.53109)

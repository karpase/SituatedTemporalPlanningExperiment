(define (problem rcll-production-074-durative)
	...
	(:init 
		...
		(= (path-length C-BS INPUT C-CS2 INPUT) 5.32415)
		...
		(= (path-length C-BS OUTPUT C-DS OUTPUT) 4.89572)
		...
		(= (path-length C-CS1 INPUT C-CS2 OUTPUT) 6.95037)
		...
		(= (path-length C-CS2 INPUT C-BS INPUT) 5.32415)
		...
		(= (path-length C-CS2 OUTPUT C-CS1 INPUT) 6.95037)
		...
		(= (path-length C-DS OUTPUT C-BS OUTPUT) 4.89572)
		...
		(= (path-length START INPUT C-BS INPUT) 3.24225)

(define (problem rcll-production-076-durative)
	...
	(:init 
		...
		(= (path-length C-BS OUTPUT C-CS1 OUTPUT) 10.50869)
		...
		(= (path-length C-CS1 INPUT C-CS2 OUTPUT) 8.15097)
		(= (path-length C-CS1 INPUT C-DS INPUT) 4.42809)
		(= (path-length C-CS1 INPUT C-DS OUTPUT) 4.90426)
		(= (path-length C-CS1 OUTPUT C-BS INPUT) 8.770011)
		(= (path-length C-CS1 OUTPUT C-BS OUTPUT) 10.50869)
		...
		(= (path-length C-DS INPUT C-BS OUTPUT) 8.0201)
		(= (path-length C-DS INPUT C-CS1 INPUT) 4.42809)
		...
		(= (path-length C-DS OUTPUT C-CS1 INPUT) 4.90426)
		(= (path-length C-DS OUTPUT C-CS1 OUTPUT) 8.29506)

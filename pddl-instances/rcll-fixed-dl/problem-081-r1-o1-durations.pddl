(define (problem rcll-production-081-durative)
	...
	(:init 
		...
		(= (path-length C-BS INPUT C-DS INPUT) 8.4801)
		...
		(= (path-length C-CS1 OUTPUT C-CS1 INPUT) 4.27504)
		...
		(= (path-length C-CS2 INPUT C-BS INPUT) 8.51285)
		...
		(= (path-length C-CS2 INPUT C-DS INPUT) 7.37789)
		(= (path-length C-CS2 INPUT C-DS OUTPUT) 7.55677)
		...
		(= (path-length C-DS INPUT C-CS2 INPUT) 7.37789)
		...
		(= (path-length C-DS OUTPUT C-CS2 INPUT) 7.55677)

(define (problem rcll-production-082-durative)
	...
	(:init 
		...
		(= (path-length C-CS2 INPUT C-DS OUTPUT) 4.28255)
		...
		(= (path-length C-DS OUTPUT C-CS2 INPUT) 4.28255)
		...
		(= (path-length START INPUT C-CS2 INPUT) 4.72214)
		(= (path-length START INPUT C-CS2 OUTPUT) 3.39026)
		(= (path-length START INPUT C-DS INPUT) 5.888799)
		(= (path-length START INPUT C-DS OUTPUT) 6.23085)
	)

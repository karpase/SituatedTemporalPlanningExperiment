(define (problem rcll-production-084-durative)
	...
	(:init 
		...
		(= (path-length C-BS OUTPUT C-CS2 INPUT) 9.70091)
		...
		(= (path-length C-CS2 INPUT C-DS INPUT) 3.71538)
		...
		(= (path-length C-DS INPUT C-CS1 INPUT) 3.03645)
		(= (path-length C-DS INPUT C-CS1 OUTPUT) 2.783468)
		(= (path-length C-DS INPUT C-CS2 INPUT) 3.71538)
		(= (path-length C-DS INPUT C-CS2 OUTPUT) 6.351542)
		(= (path-length C-DS INPUT C-DS OUTPUT) 3.21889)
		...
		(= (path-length C-DS OUTPUT C-DS INPUT) 3.21889)
		(= (path-length START INPUT C-BS INPUT) 3.13343)

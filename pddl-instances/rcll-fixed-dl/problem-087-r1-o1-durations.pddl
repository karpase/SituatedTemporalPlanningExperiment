(define (problem rcll-production-087-durative)
	...
	(:init 
		...
		(= (path-length C-BS INPUT C-CS1 INPUT) 12.02976)
		(= (path-length C-BS INPUT C-CS1 OUTPUT) 9.63609)
		...
		(= (path-length C-CS2 INPUT C-DS OUTPUT) 1.30324)
		...
		(= (path-length C-DS INPUT C-DS OUTPUT) 3.329)

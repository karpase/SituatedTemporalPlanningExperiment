(define (problem rcll-production-089-durative)
	...
	(:init 
		...
		(= (path-length C-BS INPUT C-CS2 OUTPUT) 11.77148)
		...
		(= (path-length C-BS OUTPUT C-DS OUTPUT) 6.95135)
		...
		(= (path-length C-CS1 INPUT C-CS2 INPUT) 4.81412)
		(= (path-length C-CS1 INPUT C-CS2 OUTPUT) 7.13442)
		...
		(= (path-length C-CS2 OUTPUT C-BS INPUT) 11.77148)

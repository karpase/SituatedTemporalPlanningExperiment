(define (problem rcll-production-091-durative)
	...
	(:init 
		...
		(= (path-length C-CS1 INPUT C-CS2 OUTPUT) 7.21271)
		...
		(= (path-length C-CS2 OUTPUT C-CS1 INPUT) 7.21271)
		(= (path-length C-CS2 OUTPUT C-CS1 OUTPUT) 6.69953)
		...
		(= (path-length C-DS OUTPUT C-CS1 OUTPUT) 6.06634)

(define (problem rcll-production-092-durative)
	...
	(:init 
		...
		(= (path-length C-BS OUTPUT C-CS1 INPUT) 10.40439)
		...
		(= (path-length C-CS1 OUTPUT C-CS2 INPUT) 11.06479)
		(= (path-length C-CS1 OUTPUT C-CS2 OUTPUT) 10.92592)
		...
		(= (path-length START INPUT C-DS OUTPUT) 7.04447)
	)

(define (problem rcll-production-093-durative)
	...
	(:init 
		...
		(= (path-length C-BS INPUT C-DS OUTPUT) 7.4177)
		...
		(= (path-length C-BS OUTPUT C-CS2 OUTPUT) 5.12294)
		...
		(= (path-length C-CS1 INPUT C-CS1 OUTPUT) 2.74402)
		(= (path-length C-CS1 INPUT C-CS2 INPUT) 8.27734)
		...
		(= (path-length C-CS1 OUTPUT C-CS1 INPUT) 2.74402)
		...
		(= (path-length C-CS1 OUTPUT C-DS OUTPUT) 5.3169)
		(= (path-length C-CS2 INPUT C-BS INPUT) 1.939481)
		(= (path-length C-CS2 INPUT C-BS OUTPUT) 4.116)
		...
		(= (path-length C-CS2 OUTPUT C-BS OUTPUT) 5.12294)
		...
		(= (path-length C-CS2 OUTPUT C-DS OUTPUT) 3.8903)
		...
		(= (path-length C-DS OUTPUT C-CS2 OUTPUT) 3.8903)

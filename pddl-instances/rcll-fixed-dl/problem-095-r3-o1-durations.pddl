(define (problem rcll-production-095-durative)
	...
	(:init 
		...
		(= (path-length C-BS OUTPUT C-CS1 OUTPUT) 11.36904)
		...
		(= (path-length C-CS1 INPUT C-BS INPUT) 9.63959)
		...
		(= (path-length C-CS1 OUTPUT C-BS OUTPUT) 11.36904)
		(= (path-length C-CS1 OUTPUT C-CS1 INPUT) 2.594709)
		(= (path-length C-CS1 OUTPUT C-CS2 INPUT) 7.19702)

(define (problem rcll-production-097-durative)
	...
	(:init 
		...
		(= (path-length C-BS INPUT C-DS INPUT) 6.98672)
		(= (path-length C-BS INPUT C-DS OUTPUT) 8.97799)
		...
		(= (path-length C-BS OUTPUT C-CS2 OUTPUT) 2.15613)
		...
		(= (path-length C-CS2 OUTPUT C-BS OUTPUT) 2.15613)
		...
		(= (path-length C-CS2 OUTPUT C-DS OUTPUT) 7.92149)
		(= (path-length C-DS INPUT C-BS INPUT) 6.98672)
		...
		(= (path-length C-DS OUTPUT C-CS2 OUTPUT) 7.92149)
		...
		(= (path-length START INPUT C-CS1 OUTPUT) 7.72666)

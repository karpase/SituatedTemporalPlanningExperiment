(define (problem rcll-production-098-durative)
	...
	(:init 
		...
		(= (path-length C-DS INPUT C-CS1 OUTPUT) 7.04386)
		...
		(= (path-length C-DS OUTPUT C-BS INPUT) 5.17992)

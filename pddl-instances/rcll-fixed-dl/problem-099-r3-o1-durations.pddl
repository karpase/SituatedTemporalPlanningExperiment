(define (problem rcll-production-099-durative)
	...
	(:init 
		...
		(= (path-length C-BS INPUT C-DS OUTPUT) 8.21661)
		(= (path-length C-BS OUTPUT C-BS INPUT) 3.121862)
		(= (path-length C-BS OUTPUT C-CS1 INPUT) 4.61837)
		...
		(= (path-length C-CS1 INPUT C-BS OUTPUT) 4.61837)
		...
		(= (path-length C-DS OUTPUT C-BS INPUT) 8.21661)
		...
		(= (path-length START INPUT C-CS1 OUTPUT) 4.28654)

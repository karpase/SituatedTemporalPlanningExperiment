(define (problem rcll-production-100-durative)
	...
	(:init 
		...
		(= (path-length C-CS2 INPUT C-DS INPUT) 5.20517)
		...
		(= (path-length C-CS2 OUTPUT C-DS INPUT) 4.30654)
		...
		(= (path-length C-DS INPUT C-CS2 INPUT) 5.20517)
		(= (path-length C-DS INPUT C-CS2 OUTPUT) 4.30654)
		...
		(= (path-length START INPUT C-DS INPUT) 7.57014)

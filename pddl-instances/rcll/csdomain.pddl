...
(define (domain rcll-production-durative)
	...
	(:predicates
		...
		(wp-on-shelf ?wp - workpiece ?m - mps ?spot - shelf-spot)
                ...
                (can-commit-for-ontime-delivery ?ord - order)
                (committed-for-ontime-delivery ?ord - order)
                (not-committed-for-ontime-delivery ?ord - order)                
  ...
  ; to properly handle additional bases:
	...
	(:durative-action rs-mount-ring1
		...
		:effect (and (at start (not (mps-state ?m PROCESSING))) (at end (mps-state ?m READY-AT-OUTPUT))
								 (at start (not (rs-prepared-color ?m ?col)))
								 (at start (not (wp-at ?wp ?m INPUT))) (at end (wp-at ?wp ?m OUTPUT))
								 (at start (not (wp-ring1-color ?wp RING_NONE))) (at end (wp-ring1-color ?wp ?col))
	...
	(:durative-action rs-mount-ring2
		...
		:effect (and (at start (not (mps-state ?m PROCESSING))) (at end (mps-state ?m READY-AT-OUTPUT))
								 (at start (not (rs-prepared-color ?m ?col)))
								 (at start (not (wp-at ?wp ?m INPUT))) (at end (wp-at ?wp ?m OUTPUT))
								 (at start (not (wp-ring2-color ?wp RING_NONE))) (at end (wp-ring2-color ?wp ?col))
								 (at start (not (rs-filled-with ?m ?rs-before))) (at end (rs-filled-with ?m ?rs-after)))
	)
	...
	(:durative-action rs-mount-ring3
		...
		:effect (and (at start (not (mps-state ?m PROCESSING))) (at end (mps-state ?m READY-AT-OUTPUT))
								 (at start (not (rs-prepared-color ?m ?col)))
								 (at start (not (wp-at ?wp ?m INPUT))) (at end (wp-at ?wp ?m OUTPUT))
								 (at start (not (wp-ring3-color ?wp RING_NONE))) (at end (wp-ring3-color ?wp ?col))
								 (at start (not (rs-filled-with ?m ?rs-before))) (at end (rs-filled-with ?m ?rs-after)))
	)
	...
	(:durative-action enter-field
		...
		:effect (and (at end (entered-field ?r))
								 ...
								 (at start (not (robot-waiting ?r))) (at end (can-hold ?r)))
	)
	...
	(:durative-action wp-get
		...
		:effect (and (at start (not (wp-at ?wp ?m ?side))) (at end (holding ?r ?wp)) (at start (not (can-hold ?r)))
	...
	(:durative-action wp-put-slide-cc
		...
		:effect (and (at start (not (wp-usable ?wp))) (at start (not (holding ?r ?wp))) (at end (can-hold ?r))
								 (at start (not (rs-filled-with ?m ?rs-before))) (at end (rs-filled-with ?m ?rs-after)))
	)
	...
	(:durative-action fulfill-order-c0-ignore-tw
		:parameters (?ord - order ?wp - workpiece ?m - mps ?g - ds-gate
		             ?basecol - product-base-color ?capcol - product-cap-color)
                :duration (= ?duration 1000)
		:condition (and (at start (not-committed-for-ontime-delivery ?ord)) (at start (wp-at ?wp ?m INPUT)) (at start (wp-usable ?wp))
											 (at start (mps-type ?m DS)) (at start (mps-state ?m PROCESSING)) (at start (ds-prepared-gate ?m ?g))
											 (at start (order-complexity ?ord C0)) (at start (order-gate ?ord ?g))
											 (at start (order-base-color ?ord ?basecol)) (at start (wp-base-color ?wp ?basecol))
											 (at start (order-cap-color ?ord ?capcol)) (at start (wp-cap-color ?wp ?capcol))
	...
	(:durative-action fulfill-order-c1-ignore-tw
		:parameters (?ord - order ?wp - workpiece ?m - mps ?g - ds-gate
		             ?basecol - product-base-color ?capcol - product-cap-color
		             ?ring1col - product-ring-color)
                :duration (= ?duration 1000)
	...
	(:durative-action fulfill-order-c2-ignore-tw
		:parameters (?ord - order ?wp - workpiece ?m - mps ?g - ds-gate
		             ?basecol - product-base-color ?capcol - product-cap-color
		             ?ring1col ?ring2col - product-ring-color)
                :duration (= ?duration 1000)
	...
	(:durative-action fulfill-order-c3-ignore-tw
		:parameters (?ord - order ?wp - workpiece ?m - mps ?g - ds-gate
		             ?basecol - product-base-color ?capcol - product-cap-color
		             ?ring1col ?ring2col ?ring3col - product-ring-color)
                :duration (= ?duration 1000)
	...
	(:action commit-to-ontime-delivery
		:parameters (?ord - order)
		:precondition (and (can-commit-for-ontime-delivery ?ord))

		:effect (and (not (can-commit-for-ontime-delivery ?ord)) (committed-for-ontime-delivery ?ord))
	)

	(:action do-not-commit-to-ontime-delivery
		:parameters (?ord - order)
		:precondition (and (can-commit-for-ontime-delivery ?ord))

		:effect (and (not (can-commit-for-ontime-delivery ?ord)) (not-committed-for-ontime-delivery ?ord))
	)

(define (problem rcll-production-008-durative)
  ...
  (:init (order-delivery-window-open o1) (at 138.509 (not (order-delivery-window-open o1))) (can-commit-for-ontime-delivery o1) (at 6.19 (not (can-commit-for-ontime-delivery o1)))
   (mps-type C-BS BS)
   (mps-type C-CS1 CS)
   (mps-type C-CS2 CS) 
   (mps-type C-DS DS)

(define (problem rcll-production-042-durative)
  ...
  (:init (order-delivery-window-open o1) (at 131.012 (not (order-delivery-window-open o1))) (can-commit-for-ontime-delivery o1) (at 5.55 (not (can-commit-for-ontime-delivery o1)))
   (mps-type C-BS BS)
   (mps-type C-CS1 CS)
   (mps-type C-CS2 CS) 
   (mps-type C-DS DS)

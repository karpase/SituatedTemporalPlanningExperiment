...
(:init
	...
	(at 1074.453 (not (delivery_destination phdarea)))

	(at 274.453 (delivery_destination meeting-room))
	(at 874.453 (not (delivery_destination meeting-room)))

    (delivery_destination coffee)
	(at 774.453 (not (delivery_destination coffee)))

    (delivery_destination dan-office)
	(at 274.453 (not (delivery_destination dan-office)))

	(bailout_available)	
	(bailout_location dock-station)	
	(= (bailout_distance) 19.69)
	(at 17 (= (bailout_distance) 18.77))
	(at 34 (= (bailout_distance) 15.49))
	(at 51 (= (bailout_distance) 12.49))
	(at 68 (= (bailout_distance) 9.49))
	(at 72 (= (bailout_distance) 9.48))
